...
<style type="text/css">
	...
	<script type="text/javascript">
		function submitForm(el){
			$('#newForm').form('submit',{
				url:'${path}/hospital/woman!modifyRecord.qt?chkAccess=${param.chkAccess}&random='+getRandomNum(),
				onSubmit:function(){
		...
		<form id="newForm" name="newForm" method="post">
			...
			<table style="width:100%;table-layout:fixed;" border="1" cellpadding="0" cellspacing="0">
	    		<tr>
	    			<th>复诊记录：</th>
	    			<td style="height: 1%;">
	    				<textarea id="woman.visitRecord" name="woman.visitRecord" class="easyui-validatebox" validType="filterWord[0,150]" rows="5" required="true" style="width:350px;" ></textarea>
	    			</td>
	    		</tr>
	    		<tr>
	    			<th>复诊次第：</th>
	    			<td>
	    				<input type="hidden" id="woman.count" name="woman.count" value="${item.count+1}" />
	    				${item.count+1}
	    			</td>
	    		</tr>
	    		<tr>
