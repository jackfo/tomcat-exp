...
<script type="text/javascript" src="${path }/js/bgshade/jQuery_plug_bgshade.js"></script>
	...
	<body>
		<form id="newForm" name="newForm" action="${path }/hospital/woman!womanImport.qt?chkAccess=${param.chkAccess}" method="POST" enctype="multipart/form-data">
	    		...
	    		<tr>
	    			...
	    			<td height="50px;">
						<p style="margin:0px;padding:0px;margin-bottom:10px;text-align:center;">
							<a title="点击下载" href="${path }/uploadTemplate?name=WomanImport.xls" style="text-decoration:underline;font-size: 18px; color: red;">点击下载孕妇信息导入模板</a>
						</p>
					</td>
	    		</tr>
	    		<tr>
