...
<style type="text/css">
	...
	<script type="text/javascript">
		function submitForm(el){			
			$('#newForm').form('submit',{
				url:'${path}/hospital/vaccine!modify.qt?random='+getRandomNum()+'&chkAccess='+encodeURIComponent('${param.chkAccess}'),
				onSubmit:function(){
		...
		<form id="newForm" name="newForm" method="post">
			...
			<table style="width:100%;table-layout:fixed;" border="0" cellpadding="0" cellspacing="0">
				<tr>
    				<th>疫苗名称：</th>
	    			<td>
	    				<input id="vaccineType.name" name="vaccineType.name" value="${item.name }" class="easyui-validatebox" required="true" maxlength="20" style="width:350px;">
	    			</td>
	    		</tr>
	    		<tr>
	    			<th>疫苗描述：</th>
	    			<td>
	    				<textarea id="vaccineType.descContent" name="vaccineType.descContent" class="easyui-validatebox" required="true"  maxlength="100" style="width:350px;">${item.descContent }</textarea>
	    			</td>
	    		</tr>
	    		<tr>
