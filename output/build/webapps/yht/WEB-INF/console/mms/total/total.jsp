	...
	<head>
		...
		<script type="text/javascript">
			function submitForm(el){
				$('#newForm').form('submit',{
					url:'${path}/mms/chart!total.qt?random='+getRandomNum(),
					onSubmit:function(){
		...
		<form id="newForm" name="newForm" method="post">
			...
			<table style="width:100%;table-layout:fixed;" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<th>汇总月份：</th>
	    			<td>
	    				<input type="text" name="yearMonth" class="easyui-validatebox" value="<%=new SimpleDateFormat("yyyy-MM").format(new Date()) %>" methodType="chooseDate{dateFmt:'yyyy-MM'}" required="true"/>
	    			</td>
	    		</tr>
	    		<tr>
