...
<form id="SendForm" name="SendForm" target="hiddenIframe" action="${path}/sms/sendMsg!sendMoneyBatch.qt?chkAccess=${fs:chkAccess(param.mid,'SAVE') }" method="post" enctype="multipart/form-data">
	<table class="sendBatchTable" align="center" cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td width="80">所属业务：</td>
			<td>工资短信提醒&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<font color="red">
					<b><a title="点击下载" href="${path }/uploadTemplate?name=SalaryMessage.xls">点击下载工资短信提醒模板</a>
					</b>
				</font>
			</td>
		</tr>
		...
		<tr>
			<td colspan="2" style="padding-left:30px;height: 100px;">
				<ol>
					...
					<li>如果设置定时发送，则该文件中的所有短信都采用这个时间。</li>
				</ol>
			</td>
		</tr>
	</table>
