	...
	<head>
		...
		<script type="text/javascript">
			...
			function submitForm(el){
				...
				$('#newForm').form('submit',{
					url:'${path}/sms/vote!start.qt?random='+getRandomNum(),
					onSubmit:function(){
			...
			<table style="width:100%;table-layout:fixed;" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td colspan="2" valign="middle">
						<input type="checkbox" id="isSendMsg" name="isSendMsg" value="1" style="margin-right:5px"<c:if test="${vote.status ne 1 }"> checked="checked"</c:if>/><label for="isSendMsg">是</label>
					</td>
				</tr>
				<tr>
