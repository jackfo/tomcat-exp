		...
		function submitForm(el){
			if(null==$("#year").val() || ""==$("#year").val()){
				...
				$('#downloadYearForm').form('submit',{
					url:'${path}/sms/received!downloadYearSms.qt?chkAccess=${param.chkAccess}',
					onSubmit:function(){
