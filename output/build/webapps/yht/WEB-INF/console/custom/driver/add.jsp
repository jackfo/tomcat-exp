...
<title>新增</title>
	...
	<script type="text/javascript">
		function submitForm(el){
			$('#newForm').form('submit',{
				url:'${path}/db/driver!newAdd.qt?chkAccess=${param.chkAccess}&random='+getRandomNum(),
				onSubmit:function(){
		...
		<form id="newForm" name="newForm" method="post">
			...
			<table style="width:100%;table-layout:fixed;" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<th>名称：</th>
					<td>
						<input type="text" id="driver.name" name="driver.name" class="easyui-validatebox" validType="exist['${path }/db/driver!isExist.qt?chkAccess=${param.chkAccess}','','^[.\\-\\w]+$']" required="true" maxlength="50" style="width:70%;"/>
					</td>
				</tr>
				<tr>
					<th>Class：</th>
	    			<td>
	    				<input type="text" id="driver.clazz" name="driver.clazz" class="easyui-validatebox" required="true" maxlength="200" style="width:70%;"/>
	    			</td>
	    		</tr>
				<tr>
					<th>URL：</th>
	    			<td>
	    				<input type="text" id="driver.url" name="driver.url" class="easyui-validatebox" required="true" maxlength="200" style="width:70%;"/>
	    			</td>
	    		</tr>
	    		<tr>
