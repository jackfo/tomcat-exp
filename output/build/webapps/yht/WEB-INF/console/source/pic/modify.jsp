...
<style type="text/css">
	...
	<script type="text/javascript">
		function submitForm(el){
			$('#newForm').form('submit',{
				url:'${path}/source/mmPicTypeBean!modify.qt?chkAccess=${param.chkAccess}&random='+getRandomNum(),
				onSubmit:function(){
	...
	<body>
		<form id="newForm" name="newForm" method="post">
			...
			<input type="hidden" name="id" value="${mmPicTypeBean.id }"/>
			<table style="width:100%;table-layout:fixed;" border="0" cellpadding="0" cellspacing="0">
	    		<tr>
	    			<th style="width:100">图片类别名称：</th>
	    			<td>
	    				<input id="mmPicTypeBean.picTypeName" name="mmPicTypeBean.picTypeName" value="${mmPicTypeBean.picTypeName }" class="easyui-validatebox" required="true"  maxlength="15" style="width:200px;"/>
	    			</td>
	    		</tr>
	    		<tr>
