...
<style type="text/css">
	...
	<script type="text/javascript">
		function submitForm(el){
			...
			$('#newForm').form('submit',{
				url:'${path}/source/forbiddenWord!modify.qt?chkAccess=${param.chkAccess}&random='+getRandomNum(),
				onSubmit:function(){
	...
	<body>
		<form id="newForm" name="newForm" method="post">
			...
			<input type="hidden" name="forbiddenWord.id" value="${forbiddenWord.id }"/>
			<table style="width:100%;table-layout:fixed;" border="0" cellpadding="0" cellspacing="0">
	    		<tr style="height: 50px;">
	    			<th>过滤字符：</th>
	    			<td>
	    				<textarea id="forbiddenWord.forbiddenWord" name="forbiddenWord.forbiddenWord" rows="3" cols="55" class="easyui-validatebox" required="true">${forbiddenWord.forbiddenWord}</textarea>
	    			</td>
	    		</tr>
	    		<tr>
