...
<style type="text/css">
	...
	<script type="text/javascript">
		function submitForm(el){
			$('#newForm').form('submit',{
				url:'${path}/source/fbMobile!newAdd.qt?chkAccess=${param.chkAccess}&random='+getRandomNum(),
				onSubmit:function(){
		...
		<form id="newForm" name="newForm" method="post">
			...
			<table style="width:100%;table-layout:fixed;" border="0" cellpadding="0" cellspacing="0">
	    		<tr>
	    			<th>过滤号码：</th>
	    			<td>
	    				<input id="forbiddenMobile.forbiddenMobile" name="forbiddenMobile.forbiddenMobile" class="easyui-validatebox" required="true" validType="exist['${path }/source/fbMobile!exist.qt?chkAccess=${param.chkAccess}','test']" maxlength="11" style="width:200px;">
	    			</td>
	    		</tr>
	    		<tr>
