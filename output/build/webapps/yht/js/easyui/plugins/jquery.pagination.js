...
(function($) {
	function _1(_2) {
		...
		if (_3.buttons) {
			...
			for (var i = 0; i < _3.buttons.length; i++) {
				...
				if (_5 == "-") {
					...
					$("<a href=\"javascript:void(0)\"></a>").addClass("l-btn").css("float", "left").text(_5.text || "").attr("icon", _5.iconCls || "").bind("click", eval(_5.handler ||
		...
		_4.find("a[icon=pagination-first]").unbind(".pagination").bind("click.pagination",
		function() {
			if (_3.pageNumber > 1) {
				_a(_2, 1);
			}
		});
		_4.find("a[icon=pagination-prev]").unbind(".pagination").bind("click.pagination",
		function() {
			if (_3.pageNumber > 1) {
				_a(_2, _3.pageNumber - 1);
			}
		});
		_4.find("a[icon=pagination-next]").unbind(".pagination").bind("click.pagination",
		function() {
		...
		_4.find("a[icon=pagination-last]").unbind(".pagination").bind("click.pagination",
		function() {
		...
		_4.find("a[icon=pagination-load]").unbind(".pagination").bind("click.pagination",
		function() {
		...
		_4.find("input.pagination-num").unbind(".pagination").bind("keydown.pagination",
		function(e) {
			if (e.keyCode == 13) {
		...
		_4.find(".pagination-page-list").unbind(".pagination").bind("change.pagination",
		function() {
