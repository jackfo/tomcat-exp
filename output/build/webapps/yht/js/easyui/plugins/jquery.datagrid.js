...
(function($) {
	...
	function _27(_28, _29) {
		...
		_2e.panel("panel").addClass("datagrid").bind("_resize",
		function(e, _2f) {
	...
	function _39(_3a) {
		...
		if (_3b.toolbar) {
			...
			for (var i = 0; i < _3b.toolbar.length; i++) {
				...
				if (btn == "-") {
					...
					_43[0].onclick = eval(btn.handler ||
					function() {});
					_43.css("float", "left").appendTo(tb).linkbutton($.extend({},
					btn, {
						plain: true
					}));
				}
		...
		if (_3b.pagination) {
			...
			_44.pagination({
				pageNumber: _3b.pageNumber,
				pageSize: _3b.pageSize,
				pageList: _3b.pageList,
				onSelectPage: function(_45, _46) {
					_3b.pageNumber = _45;
					_3b.pageSize = _46;
					_139(_3a);
				}
	...
	function _4d(_4e) {
		...
		_52.find("tr[datagrid-row-index]").unbind(".datagrid").bind("mouseenter.datagrid",
		function() {
		...
		_52.find("div.datagrid-cell-check input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",
		function(e) {
	...
	function _5c(_5d) {
		...
		_60.find("td:has(div.datagrid-cell)").unbind(".datagrid").bind("mouseenter.datagrid",
		function() {
		...
		_60.find("div.datagrid-cell").unbind(".datagrid").bind("click.datagrid",
		function() {
		...
		_60.find("input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",
		function() {
			if (_5f.singleSelect) {
				return false;
			}
		...
		_66.children("div.datagrid-body").unbind(".datagrid").bind("scroll.datagrid",
		function() {
		...
		_60.find("div.datagrid-cell").resizable({
			handles: "e",
			minWidth: 25,
			onStartResize: function(e) {
				var _67 = _64.children("div.datagrid-resize-proxy");
				_67.css({
					left: e.pageX - $(_5e).offset().left - 1
				});
		...
		$("div.datagrid-view1 div.datagrid-header div.datagrid-cell", _5e).resizable({
			onStopResize: function(e) {
	...
	function _a6(_a7) {
		...
		if (_a8.idField) {
			...
			var _ad = [];
			for (var i = 0; i < _ac.length; i++) { (function() {
					var row = _ac[i];
			...
			if (col && col.editor) {
				...
				if (_10a) {
					...
					$.data(cell[0], "datagrid.editor", {
						actions: _10a,
						target: _10a.init(cell.find("td"), _109),
						field: _107,
						type: _108
					});
				}
	...
	$.fn.datagrid = function(_146, _147) {
		...
		return this.each(function() {
			...
			if (_148) {
				...
				opts = $.extend({},
				$.fn.datagrid.defaults, $.fn.datagrid.parseOptions(this), _146);
	...
	$.fn.datagrid.methods = {
		options: function(jq) {
			...
			var opts = $.extend(_192, {
				width: _193.width,
				height: _193.height,
				closed: _193.closed,
				collapsed: _193.collapsed,
				minimized: _193.minimized,
				maximized: _193.maximized
			});
			var _194 = jq.datagrid("getPager");
			if (_194.length) {
				var _195 = _194.pagination("options");
				$.extend(opts, {
					pageNumber: _195.pageNumber,
					pageSize: _195.pageSize
				});
			}
			return opts;
		},
	...
	$.fn.panel.defaults, {
		...
		remoteSort: true,
		showFooter: false,
		rowStyler: function(_1cd, _1ce) {},
		editors: _14a,
		view: _1ae,
		onBeforeLoad: function(_1cf) {},
