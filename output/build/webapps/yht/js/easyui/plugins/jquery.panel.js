...
(function($) {
	...
	function _13(_14) {
		...
		if (_15.title && !_15.noheader) {
			var _17 = $("<div class=\"panel-header\"><div class=\"panel-title\">" + (_15.showText?_15.showText:_15.title) + "</div></div>").prependTo(_16);
			if (_15.iconCls) {
	...
	$.fn.panel = function(_59, _5a) {
		...
		return this.each(function() {
			...
			if (_5b) {
				...
				_5c = $.extend({},
				$.fn.panel.defaults, $.fn.panel.parseOptions(this), _59);
				$(this).attr("title", "");
				_5b = $.data(this, "panel", {
					options: _5c,
					panel: _f(this),
