...
(function($) {
	...
	function _15(_16) {
		...
		_1b.unbind(".combo");
		if (!_17.disabled) {
			$(document).bind("mousedown.combo",
			function(e) {
				$("div.combo-panel").panel("close");
			});
			_19.bind("mousedown.combo",
			function(e) {
				return false;
			});
			_1a.bind("mousedown.combo",
			function(e) {
				e.stopPropagation();
			}).bind("keydown.combo",
			function(e) {
	...
	function _1c(_1d) {
		...
		_20.panel("open");
		_1e.onShowPanel.call(_1d); (function() {
			if (_20.is(":visible")) {
				_20.panel("move", {
					left: _1f.offset().left,
					top: _21()
	...
	$.fn.combo = function(_50, _51) {
		...
		return this.each(function() {
			...
			if (_52) {
				...
				_52 = $.data(this, "combo", {
					options: $.extend({},
					$.fn.combo.defaults, $.fn.combo.parseOptions(this), _50),
					combo: r.combo,
					panel: r.panel,
					previousValue: null
				});
	...
	$.fn.combo.parseOptions = function(_58) {
		var t = $(_58);
		return $.extend({},
		$.fn.validatebox.parseOptions(_58), {
