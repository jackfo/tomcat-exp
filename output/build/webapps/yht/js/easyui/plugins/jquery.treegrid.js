...
(function($) {
	...
	function _15(_16) {
		...
		_19.find("span.tree-hit").unbind(".treegrid").bind("click.treegrid",
		function() {
		...
		_19.find("tr[node-id]").unbind(".treegrid").bind("mouseenter.treegrid",
		function() {
		...
		_19.find("div.datagrid-cell-check input[type=checkbox]").unbind(".treegrid").bind("click.treegrid",
		function(e) {
		...
		_1a.find("input[type=checkbox]").unbind().bind("click.treegrid",
		function() {
			if (_17.singleSelect) {
				return false;
			}
	...
	function _6c(_6d, _6e) {
		...
		function _72(_74) {
			...
			if (_75 && _75.children) {
				for (var i = 0,
				len = _75.children.length; i < len; i++) {
	...
	$.fn.treegrid = function(_c2, _c3) {
		...
		return this.each(function() {
			...
			if (_c4) {
				...
				$.data(this, "treegrid", {
					options: $.extend({},
					$.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _c2),
					data: []
				});
			}
			_1(this);
