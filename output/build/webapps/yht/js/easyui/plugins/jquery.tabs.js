...
(function($) {
	...
	function _12(_13) {
		...
		if (_14.tools) {
			...
			for (var i = 0; i < _14.tools.length; i++) {
				...
				_17[0].onclick = eval(_14.tools[i].handler ||
				function() {});
				_17.linkbutton($.extend({},
				_14.tools[i], {
					plain: true
				}));
			}
	...
	function _38(_39, pp, _3a) {
		...
		var _3f = $("<span class=\"tabs-title\"></span>").html(_3b.showText?_3b.showText:_3b.title).appendTo(_3e);//如果有showText，则显示它
	...
	function _41(_42, _43) {
		...
		_7(_42);
		_2d(_42);
		var selected = _43.selected;//执行add方法时默认选中，如果selected为false则不选中。
	...
	function _47(_48, _49) {
		...
		tab.find("span.tabs-title").html(_4c.showText?_4c.showText:_4c.title);//如果showText存在则使用showText，否则使用title
		if (_4c.closable) {
	...
	$.fn.tabs = function(_6b, _6c) {
		...
		return this.each(function() {
			...
			if (_6d) {
				...
				$.data(this, "tabs", {
					options: $.extend({},
					$.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _6b),
					tabs: _27(this),
					selectHis: []
				});
			}
