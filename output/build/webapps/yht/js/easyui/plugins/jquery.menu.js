 ...
 */
(function($) {
	//重新优化menu菜单的隐藏事件，定时句柄使用option中的值
	function _1(_2) {
		$(_2).appendTo("body");
		$(_2).addClass("menu-top");
		var opt = $.data(_2, "menu").options;
		var _3 = [];
		_4($(_2));
	...
	function _10(_11, _12) {
		...
		_12.click(function() {
			...
			opt.onClick.call(_11, _14);
		});
		//给子menu容器添加鼠标事件，主要是鼠标移除后消失。
		...
		_12.hover(function() {
			...
			if (_15) {
				...
				_1f(_15, {
					left: _16,
					top: _12.offset().top - 3
				});
				//当鼠标进过的时候激活事件
				opt.onMouseOver.call(_11, _12);
			}
		},
		function(e) {
		...
		_12.unbind(".menu").bind("mousedown.menu",
		function() {
			return false;
		});
	};
	...
	function _1c(_1d, pos) {
		...
		_1e.onBeforeShow.call(_1d);	//增加menu展开之前的事件
		if (pos) {
			_1e.left = pos.left;
			_1e.top = pos.top;
		}
	...
	function _2b(_2c, _2d) {
		...
		$("<div class=\"menu-text\"></div>").appendTo(_2f).html(_2d.text);	//修复menu插入顺序错误
		if (_2d.iconCls) {
		...
		//修复手动创建submenu
		if(_2d.submenu){
			_2f[0].submenu = _2d.submenu;
			$("<div class=\"menu-rightarrow\"></div>").appendTo(_2f);
		}
		_10(_2c, _2f);
	};
	...
	$.fn.menu.defaults = {
		...
		left: 0,
		top: 0,
		onBeforeShow: function(){},	//增加menu展开之前的事件
		onShow: function() {},
		onHide: function() {},
		onClick: function(_43) {},
		onMouseOver: function(item){}	//鼠标进过事件
	};
})(jQuery);