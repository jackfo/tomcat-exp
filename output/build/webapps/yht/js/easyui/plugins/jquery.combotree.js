...
(function($) {
	function _1(_2) {
		...
		_3, {
			...
			onClick: function(_a) {
				if(_3.check){
					var _12 = _4.tree("getSelected");
					if(_3.check&&!_3.check(_12)) return;
				}
				_d(_2);
				$(_2).combo("hidePanel");
	...
	function _13(_14, _15) {
		...
		for (var i = 0; i < _15.length; i++) {
			...
			if (_18) {
				...
				s = $(_14).attr('showText');	//当id对应的值未加载时获取元素上的showText
			}
			vv.push(v);
			ss.push(s);
		}
	...
	$.fn.combotree = function(_19, _1a) {
		...
		return this.each(function() {
			...
			if (_1c) {
				...
				$.data(this, "combotree", {
					options: $.extend({},
					$.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _19)
				});
			}
			_1(this);
		});
	...
	$.fn.combotree.parseOptions = function(_25) {
		return $.extend({},
		$.fn.combo.parseOptions(_25), $.fn.tree.parseOptions(_25));
	};
