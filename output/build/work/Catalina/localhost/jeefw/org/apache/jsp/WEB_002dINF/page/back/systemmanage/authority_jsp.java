 ...
 * Generated at: 2017-10-17 14:38:14 UTC
...
return;
    ...
    try {
      ...
      out.write("</div><!-- /.row -->\r\n");
      out.write("\r\n");
      out.write("<div id=\"button-modal-table\" class=\"modal fade\" tabindex=\"-1\" data-backdrop=\"static\">\r\n");
      out.write("\t<div class=\"modal-dialog\">\r\n");
      out.write("\t\t<form id=\"authorityForm\">\r\n");
      ...
      out.write("\t\t\t\t\t<input id=\"modalValue\" type=\"hidden\" />\r\n");
      out.write("\t\t\t\t\t<input id=\"menuCodeId\" type=\"hidden\" />\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div id=\"checkboxList\" class=\"checkbox\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/static/assets/js/jqGrid/i18n/grid.locale-cn.js\", null ]\r\n");
      ...
      out.write("        \t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/sys/authority/getAuthority\",\r\n");
      out.write("        \t\t\tdatatype : \"json\",\r\n");
      out.write("        \t\t\theight : 450,\r\n");
      out.write("        \t\t\tcolNames : ['', 'ID', '菜单编码', '菜单名称', '菜单class属性值', '菜单data-url属性值', '排序', '上级菜单编码', '按钮授权'],\r\n");
      out.write("        \t\t\tcolModel : [ {\r\n");
      out.write("        \t\t\t\tname : '',\r\n");
      out.write("        \t\t\t\tindex : '',\r\n");
      out.write("        \t\t\t\twidth : 80,\r\n");
      ...
      out.write("        \t\t\t}, {\r\n");
      out.write("        \t\t\t\tname : 'menuCode',\r\n");
      out.write("        \t\t\t\tindex : 'menuCode',\r\n");
      out.write("        \t\t\t\tlabel : '菜单编码',\r\n");
      out.write("        \t\t\t\twidth : 160,\r\n");
      out.write("        \t\t\t\teditable : true,\r\n");
      out.write("        \t\t\t\teditoptions : {size : \"20\", maxlength : \"50\"},\r\n");
      out.write("        \t\t\t\tsearchoptions : {sopt : ['eq']},\r\n");
      out.write("        \t\t\t\teditrules : {required : true}\r\n");
      out.write("        \t\t\t}, {\r\n");
      out.write("        \t\t\t\tname : 'menuName',\r\n");
      out.write("        \t\t\t\tindex : 'menuName',\r\n");
      out.write("        \t\t\t\tlabel : '菜单名称',\r\n");
      out.write("        \t\t\t\twidth : 130,\r\n");
      out.write("        \t\t\t\teditable : true,\r\n");
      out.write("        \t\t\t\teditoptions : {size : \"20\", maxlength : \"50\"},\r\n");
      ...
      out.write("        \t\t\t\teditrules : {required : true}\r\n");
      out.write("        \t\t\t}, {\r\n");
      out.write("        \t\t\t\tname : 'menuClass',\r\n");
      out.write("        \t\t\t\tindex : 'menuClass',\r\n");
      out.write("        \t\t\t\tlabel : '菜单class属性值',\r\n");
      out.write("        \t\t\t\twidth : 180,\r\n");
      out.write("        \t\t\t\teditable : true,\r\n");
      out.write("        \t\t\t\teditoptions : {size : \"20\", maxlength : \"50\"},\r\n");
      out.write("        \t\t\t\teditrules : {required : true},\r\n");
      out.write("        \t\t\t\tsearch : false\r\n");
      out.write("        \t\t\t}, {\r\n");
      out.write("        \t\t\t\tname : 'dataUrl',\r\n");
      out.write("        \t\t\t\tindex : 'dataUrl',\r\n");
      out.write("        \t\t\t\tlabel : '菜单data-url属性值',\r\n");
      out.write("        \t\t\t\twidth : 130,\r\n");
      out.write("        \t\t\t\teditable : true,\r\n");
      ...
      out.write("        \t\t\t\tindex : 'sequence',\r\n");
      out.write("        \t\t\t\tlabel : '排序',\r\n");
      out.write("        \t\t\t\twidth : 50,\r\n");
      out.write("        \t\t\t\teditable : true,\r\n");
      out.write("        \t\t\t\tsorttype : \"long\",\r\n");
      out.write("        \t\t\t\tsearch : false,\r\n");
      out.write("        \t\t\t\teditrules : {number : true}\r\n");
      out.write("        \t\t\t}, {\r\n");
      out.write("        \t\t\t\tname : 'parentMenuCode',\r\n");
      out.write("        \t\t\t\tindex : 'parentMenuCode',\r\n");
      out.write("        \t\t\t\tlabel : '上级菜单编码',\r\n");
      out.write("        \t\t\t\twidth : 160,\r\n");
      out.write("        \t\t\t\teditable : true,\r\n");
      out.write("        \t\t\t\teditoptions : {size : \"20\", maxlength : \"50\", title : \"如果没有上级，不填即可\"},\r\n");
      out.write("        \t\t\t\tsearch : false\r\n");
      out.write("        \t\t\t}, {\r\n");
      out.write("        \t\t\t\tname : '',\r\n");
      out.write("        \t\t\t\tindex : '',\r\n");
      out.write("        \t\t\t\tlabel : '按钮授权',\r\n");
      out.write("        \t\t\t\twidth : 70,\r\n");
      out.write("        \t\t\t\teditable : false,\r\n");
      out.write("        \t\t\t\tsearch : false,\r\n");
      out.write("        \t\t\t\tsortable : false,\r\n");
      out.write("        \t\t\t\tformatter : buttonAuthorityFormatter\r\n");
      out.write("        \t\t\t} ],\r\n");
      ...
      out.write("        \t\t\tediturl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/sys/authority/operateAuthority\"\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/sys/authority/operateAuthority?oper=excel' method='post'>\";\r\n");
      ...
      out.write("        \t\t}\r\n");
      out.write("        \t\t\r\n");
      out.write("        \t\tfunction buttonAuthorityFormatter(cellvalue, options, cell) {\r\n");
      out.write("        \t\t\tvar template = \"<button data-toggle='modal' onclick='javascript:$(\\\"#button-modal-table\\\").modal(\\\"toggle\\\");$(\\\"#menuCodeId\\\").val(\\\"\" + cell.menuCode +\"\\\")' class='btn btn-xs btn-warning'><i class='ace-icon fa fa-flag bigger-120'></i></button>\";\r\n");
      out.write("        \t\t\tif(cell.parentMenuCode == \"0\" || cell.parentMenuCode == \"bootstrapinstance\" || cell.parentMenuCode == \"chartsreports\" || cell.menuCode == \"mail\" || cell.menuCode == \"systemmonitor\" || cell.menuCode == \"druid\"){\r\n");
      out.write("        \t\t\t\treturn \"\";\r\n");
      out.write("        \t\t\t}else{\r\n");
      ...
      out.write("        \t\t}\r\n");
      out.write("        \t\t\r\n");
      out.write("        \t\t$(\"#button-modal-table\").on('shown.bs.modal', function() {\r\n");
      out.write("        \t\t\t$(\"#modal-tip\").html(\"\");\r\n");
      out.write("        \t\t\t$.ajax({\r\n");
      out.write("    \t\t\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/sys/authority/getAuthorityButtonList?rand=\" + Math.random(1000),\r\n");
      out.write("    \t\t\t\t\tdata : {\r\n");
      out.write("    \t\t\t\t\t\tmenuCode : $(\"#menuCodeId\").val()\r\n");
      out.write("    \t\t\t\t\t},\r\n");
      out.write("    \t\t\t\t\ttype : 'POST',\r\n");
      out.write("    \t\t\t\t\tdataType : 'json',\r\n");
      out.write("    \t\t\t\t\tcomplete : function(response) {\r\n");
      out.write("    \t\t\t\t\t\tvar returninfo = eval(\"(\" + response.responseText + \")\");\r\n");
      out.write("    \t\t\t\t\t\t$(\"#checkboxList\").html(returninfo.data);\r\n");
      out.write("    \t\t\t\t\t}\r\n");
      out.write("    \t\t\t\t});\r\n");
      out.write("        \t\t});\r\n");
      out.write("        \t\t\r\n");
      out.write("        \t\t$('#submitButton').on('click', function() {\r\n");
      out.write("        \t\t\tvar allArray = [];\r\n");
      out.write("        \t\t\t$(\"input[name='form-field-checkbox']\").each(function(){\r\n");
      out.write("        \t\t\t\tif($(this).attr(\"type\") == \"checkbox\"){\r\n");
      out.write("        \t\t\t\t\tallArray.push($(this).attr(\"id\"),\",\",$(this).is(':checked') == \"\" ? \"false\" : \"true\",\";\");\r\n");
      out.write("        \t\t\t\t} else {\r\n");
      out.write("        \t\t\t\t\tallArray.push(\"AND\");\r\n");
      out.write("        \t\t\t\t}\r\n");
      out.write("        \t\t\t});\r\n");
      out.write("        \t\t\t$(\"#modalValue\").html(allArray);\r\n");
      out.write("\t\t\t\t\t$.ajax({\r\n");
      out.write("    \t\t\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/sys/authority/saveAuthorityButtonList\",\r\n");
      out.write("    \t\t\t\t\tdata : {\r\n");
      out.write("    \t\t\t\t\t\tcheckboxList : $(\"#modalValue\").text(),\r\n");
      out.write("    \t\t\t\t\t\tmenuCode : $(\"#menuCodeId\").val()\r\n");
      out.write("    \t\t\t\t\t},\r\n");
      out.write("    \t\t\t\t\ttype : 'POST',\r\n");
      out.write("    \t\t\t\t\tdataType : 'json',\r\n");
      out.write("    \t\t\t\t\tcomplete : function(response) {\r\n");
      out.write("    \t\t\t\t\t\t$(\"#button-modal-table\").modal(\"toggle\");\r\n");
      out.write("    \t\t\t\t\t}\r\n");
      out.write("    \t\t\t\t});\r\n");
      out.write("        \t\t});\r\n");
      out.write("        \t\t\r\n");
  ...
  private boolean _jspx_meth_c_005fset_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/page/back/systemmanage/authority.jsp(4,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("contextPath");
      // /WEB-INF/page/back/systemmanage/authority.jsp(4,0) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/WEB-INF/page/back/systemmanage/authority.jsp(4,0) '${pageContext.request.contextPath}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${pageContext.request.contextPath}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/page/back/systemmanage/authority.jsp(238,18) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_shiro_005fhasPermission_005f0.setName((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ROLE_KEY}:authority:edit", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_shiro_005flacksPermission_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/page/back/systemmanage/authority.jsp(238,99) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_shiro_005flacksPermission_005f0.setName((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ROLE_KEY}:authority:edit", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/page/back/systemmanage/authority.jsp(240,17) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_shiro_005fhasPermission_005f1.setName((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ROLE_KEY}:authority:add", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_shiro_005flacksPermission_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/page/back/systemmanage/authority.jsp(240,97) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_shiro_005flacksPermission_005f1.setName((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ROLE_KEY}:authority:add", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/page/back/systemmanage/authority.jsp(242,17) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_shiro_005fhasPermission_005f2.setName((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ROLE_KEY}:authority:delete", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_shiro_005flacksPermission_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/page/back/systemmanage/authority.jsp(242,100) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_shiro_005flacksPermission_005f2.setName((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ROLE_KEY}:authority:delete", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/page/back/systemmanage/authority.jsp(244,20) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_shiro_005fhasPermission_005f3.setName((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ROLE_KEY}:authority:search", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_shiro_005flacksPermission_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/page/back/systemmanage/authority.jsp(244,103) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_shiro_005flacksPermission_005f3.setName((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ROLE_KEY}:authority:search", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/page/back/systemmanage/authority.jsp(248,18) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_shiro_005fhasPermission_005f4.setName((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ROLE_KEY}:authority:view", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_shiro_005flacksPermission_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/page/back/systemmanage/authority.jsp(248,99) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_shiro_005flacksPermission_005f4.setName((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ROLE_KEY}:authority:view", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f5(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/page/back/systemmanage/authority.jsp(318,13) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_shiro_005fhasPermission_005f5.setName((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ROLE_KEY}:authority:export", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_shiro_005flacksPermission_005f5(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/page/back/systemmanage/authority.jsp(318,96) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_shiro_005flacksPermission_005f5.setName((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ROLE_KEY}:authority:export", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
