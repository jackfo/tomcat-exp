    ...
    public void invoke(Request request, Response response) throws IOException, ServletException {
        ...
        if (request.getSession(false) == null) {
            ...
            if (uaHeader != null && !uaHeaders.hasMoreElements()) {
                Debug.log(request.hashCode() + ": UserAgent=" + uaHeader,module);
                if (uaPattern.matcher(uaHeader).matches()) {
                    isBot = true;
                    Debug.log(request.hashCode() + ": Bot found. UserAgent=" + uaHeader,module);
                }
            }

            if (ipPattern != null && ipPattern.matcher(clientIp).matches()) {
                isBot = true;
                Debug.log(request.hashCode() + ": Bot found. IP=" + clientIp,module);
            }
        ...
        if (isBot) {
            if (sessionId == null) {
                ...
                if (s != null) {
                    ...
                    Debug.log(request.hashCode() + ": New bot session. SessionID=" + s.getId(),module);
                }
            } else {
                Debug.log(request.hashCode() + ": Bot session accessed. SessionID=" + sessionId,module);
            }
        }
    }
