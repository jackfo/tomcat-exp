        ...
        synchronized (connectorsLock) {
            for (Connector connector: connectors) {
                try {
                    ...
                    Debug.logError(e,sm.getString("standardService.connector.startFailed", connector),module);
                }
            }
        }
    }
        ...
        synchronized (connectorsLock) {
            for (Connector connector: connectors) {
                try {
                    ...
                    Debug.logError(e,sm.getString("standardService.connector.pauseFailed", connector),module);
                }
            }
        }

        Debug.log(sm.getString("standardService.stop.name", this.name),module);
