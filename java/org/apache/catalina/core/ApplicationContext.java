...
public class ApplicationContext implements ServletContext {
     ...
     * <code>true</code>.
     * 默认的SessionTrackingMode#URLURL总是被支持
     * 如果context支持cookie则将SessionTrackingMode#COOKIE添加进去
     * 至少具有一个connector的secure为true则将SessionTrackingMode#SSL添加进去
     */
    @Override
    ...
    private void populateSessionTrackingModes() {
        ...
        //获取SandardService之后获取其所有连接器，如果有一个的SSLEnabled属性为真则在supportedSessionTrackingModes这个集合添加SessionTrackingMode#SSL
