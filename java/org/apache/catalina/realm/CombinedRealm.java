...
public class CombinedRealm extends RealmBase {
    ...
    public static final String module = CombinedRealm.class.getName();
    ...
    public Principal authenticate(String username) {
        ...
        for (Realm realm : realms) {
            Debug.log(sm.getString("combinedRealm.authStart", username, realm.getClass().getName()),module);
            authenticatedUser = realm.authenticate(username);

            if (authenticatedUser == null) {
                Debug.log(sm.getString("combinedRealm.authFail", username, realm.getClass().getName()),module);
            } else {
                Debug.log(sm.getString("combinedRealm.authSuccess", username, realm.getClass().getName()),module);
                break;
            }
        }
        return authenticatedUser;
