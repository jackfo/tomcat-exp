...
public class Connector extends LifecycleMBeanBase  {
    ...
    /**默认超时时间以毫秒为单位的异步请求。如果没有指定，该属性被设置为30000（30秒）。*/
    ...
    /**
     * @param methods  默认传入的参数值是POST
     *
     * 1.构建一个HashSet集合
     *
     * 2.将参数字符串转化为 ArrayList集合
     *
     * 3.把ArrayList集合添加到methodSet集合
     *
     * 4.如果methodSet包含TRACE,扔出异常
     *
     * 5.将methods赋值给成员变量parseBodyMethods
     *
     * 6.将methodSet赋值给成员变量parseBodyMethodsSet
     * */
    ...
    protected void initInternal() throws LifecycleException {
        ...
        // 初始化适配器,将当前Connector实例给注入
        adapter = new CoyoteAdapter(this);
        //将适配器注入ProtocolHandler实例
