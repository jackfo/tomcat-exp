...
public class ResponseFacade
    ...
    public static final String module = ResponseFacade.class.getName();
    ...
    public void sendRedirect(String location)
        ...
        if (isCommitted()) {
            Debug.log(sm.getString("coyoteResponse.sendRedirect.ise"),module);
        }
