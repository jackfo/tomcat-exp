...
public abstract class Compiler {
    ...
    public static final String module = Compiler.class.getName();
    ...
    public boolean isOutDated(boolean checkClass) {
        ...
        if (targetLastModified != jspRealLastModified.longValue()) {
            Debug.log("Compiler: outdated: " + targetFile + " " + targetLastModified,module);
            return true;
        }
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                Debug.log(e,"Problem accessing resource. Treat as outdated.",module);
                return true;
            }
        }
    ...
    public void removeGeneratedFiles() {
        ...
        try {
            File javaFile = new File(ctxt.getServletJavaFileName());
            Debug.log("Deleting " + javaFile,module);
            if (javaFile.exists()) {
                if (!javaFile.delete()) {
                    Debug.logWarning(Localizer.getMessage("jsp.warning.compiler.javafile.delete.fail", javaFile.getAbsolutePath()),module);
                }
            }
        } catch (Exception e) {
            // Remove as much as possible, log possible exceptions
            Debug.logWarning(e,Localizer.getMessage("jsp.warning.compiler.classfile.delete.fail.unknown"),module);
        }
    }
    ...
    public void removeGeneratedClassFiles() {
        try {
            ...
            Debug.log("Deleting " + classFile,module);
            if (classFile.exists()) {
                if (!classFile.delete()) {
                    Debug.logWarning(Localizer.getMessage("jsp.warning.compiler.classfile.delete.fail", classFile.getAbsolutePath()),module);
                }
            }
        } catch (Exception e) {
            // Remove as much as possible, log possible exceptions
