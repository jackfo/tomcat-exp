...
public final class LegacyCookieProcessor extends CookieProcessorBase {
    ...
    public static final String module = LegacyCookieProcessor.class.getName();
        ...
        while (pos >= 0) {
            ...
            if (cookieValue != null && !cookieValue.isNull() ) {
                if (cookieValue.getType() != MessageBytes.T_BYTES ) {
                    ...
                    Debug.logWarning(e,"Cookies: Parsing cookie as String. Expected bytes.",module);
                    cookieValue.toBytes();
                }
                Debug.log("Cookies: Parsing b[]: " + cookieValue.toString(),module);
