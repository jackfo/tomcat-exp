...
public final class ByteChunk implements Cloneable, Serializable {
    ...
    public static final String module =ByteChunk.class.getName();
    ...
    */
     ...
     */
    public ByteChunk() {
        //Debug.log("实例化ByteChunk"+this,module);
    }
    ...
    /**
     * 分配空间
     * buff的类型是byte[]  initial是socketBufferSize为900
     * 所以是长度为900的数组
     *
     * */
        ...
        throws IOException
    {
        ...
        int avail=limit-end;
        //先把byte数组填满，flush一次 flush的作用就是调用write将数据写入
