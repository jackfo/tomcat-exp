...
public class StandardJarScanner implements JarScanner {
    ...
    public static final String module = StandardJarScanner.class.getName();
    ...
    public void scan(JarScanType scanType, ServletContext context,
        ...
        Debug.log(sm.getString("jarScan.webinflibStart"),module);
        ...
        if (dirList != null) {
            ...
            while (it.hasNext()) {
                ...
                if (path.endsWith(Constants.JAR_EXT) &&
                    ...
                    Debug.log(sm.getString("jarScan.webinflibJarScan", path),module);
                    URL url = null;
                    try {
        ...
        if (isScanClassPath()) {
            ...
            Debug.log(sm.getString("jarScan.classloaderStart"),module);
            ...
            while (classLoader != null && classLoader != stopLoader) {
                if (classLoader instanceof URLClassLoader) {
                    //判断classLoader是不是WebappClassLoader
                    if (isWebapp) {
                        isWebapp = isWebappClassLoader(classLoader);
                    }

                    //创建一个classPathUrlsToProcess集合向其中添加classLoader中所有的Url
